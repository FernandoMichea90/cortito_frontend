...
export default function Acortador() {
  ...
  return (
    <div className="h-screen w-full z-10 bg-blanco">
      <div className="flex flex-col items-center justify-center h-screen w-full ">
        <div className='w-[80vw] h-[60vh] pt-[20px] pb-[20px]  border-[#e8e9eb] border-[3px] border-solid  rounded-lg'>
          <h3 className="text-3xl font-bold text-azul dark:text-gray-400 text-center">
            Acorta tus URL
          </h3>
          {/*  input acortardor de url  */}
          <div className='h-[100%] flex flex-col justify-center '>
            <div>
            <form onSubmit={acortarUrl}>
              ...
              <button   className="mt-3 text-center vw-20 p-2 rounded-lg text-blanco bg-azul dark:text-gray-400 text-bold w-[200px]">
                Acortar
              </button>
            </form>
            </div>
